...
class ClinicalTrialsAPI:
    ...
    def list_studies(self, params=None):
        """
    ...
    def list_studies_paginated(self, params=None, max_pages=10):
        """
    ...
    def fetch_study(self, nctId, params=None):
        """
        ...
        print(study)
        """
        url = f"{self.BASE_URL}/studies/{nctId}"
        response = requests.get(url, params=params)
        return response.json()

    def studies_metadata(self, params=None):
        """
    ...
    def field_values_stats(self, params=None):
        """
    ...
    def list_field_sizes_stats(self, params=None):
        """
